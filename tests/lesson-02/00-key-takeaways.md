...
- String: có thể dùng nháy đơn '', nháy kép "", hoặc backtick `` (cạnh số 1)
- Number: Số nguyên, số thực, Infinity (chia cho 0), NaN (not a number) 
...
### Loops
for(<khởi tạo>; <điều kiện dừng>; <điều kiện tăng/giảm>) {
// code }
